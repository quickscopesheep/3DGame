...
public class Loader {
    ...
    public Model loadToVAO(float[] positions, float[] textureCoords) {
        ...
        return new Model(vaoID, positions.length/3, false);
    }
    ...
    public void storeDataInAttributeList(int attributeNumber, int dimensions, float[] data) {
    ...
    public Model loadOBJFile(String path){
        ...
        Model model = loadToVAO(verticesArray, texCoordsArray, indicesArray, normalsArray);
